  ...
  return (
    <section className="md:w-[50vw] w-[90vw] text-center mb-10">
      ...
      <p className="text-white text-md font-light mt-4 text-left">
        We are a small team focused on innovating on state of the art research in
        AI to provide value to our users. We are always in lookout for
        passionate individuals who shares similar vision. Write to us on{" "}
        <a
