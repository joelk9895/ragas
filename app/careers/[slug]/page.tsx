...
export default function JobPage({ params }: JobPageProps) {
  ...
  return (
    <>
      <Head>
        <title>{job.title} - Careers at Ragas.io</title>
        <meta
          name="description"
          content={`Apply for the ${job.title} position at Ragas.io. Location: ${job.location}. Salary: ${job.salary}. Equity: ${job.equity}.`}
        />
