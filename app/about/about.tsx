...
export default function About() {
  return (
    <section className="w-[50vw] text-center">
      ...
      <h3 className="text-white font-medium text-2xl mt-10 text-left mb-5">
        Founders
      </h3>
      <div className="flex gap-5 text-white mb-10">
        <div className="flex flex-col border border-white/[0.2] p-10 relative">
